...
/*   Updated: 2018/02/23 12:15:50 by mgreil           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av)
{
	...
	if (ac == 2)
	{
		...
		e.objs = e.objs->next;
		printf("obj[1].type = %d\n", ((t_obj*)e.lights->content)->type);
		printf("obj[1].pos.x = %f, obj[1].pos.y = %f, obj[1].pos.z = %f\n", ((t_obj*)e.lights->content)->pos.x, ((t_obj*)e.lights->content)->pos.y, ((t_obj*)e.lights->content)->pos.z);
		printf("obj[1].rad = %f\n", ((t_obj*)e.lights->content)->rad);
		printf("obj[1].color.r = %u, obj[1].color.g = %u, obj[1].color.b = %u\n", ((t_obj*)e.lights->content)->color.r, ((t_obj*)e.lights->content)->color.g, ((t_obj*)e.lights->content)->color.b);
		printf("obj[1].rot.x = %f, obj[1].rot.y = %f, obj[1].rot.z = %f\n", ((t_obj*)e.lights->content)->rot.x, ((t_obj*)e.lights->content)->rot.y, ((t_obj*)e.lights->content)->rot.z);
		printf("obj[1].trans.x = %f, obj[1].trans.y = %f, obj[1].trans.z = %f\n", ((t_obj*)e.lights->content)->trans.x, ((t_obj*)e.lights->content)->trans.y, ((t_obj*)e.lights->content)->trans.z);
